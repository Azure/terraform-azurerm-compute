...
| <a name="input_group_by_vm_instance"></a> [group\_by\_vm\_instance](#input\_group\_by\_vm\_instance)                                                  | (Optional) When `true`, all resources that are affected by `var.nb_instances` are named by host name and instance count, such as '<vm\_hostname>-<instance count>-<resource\_type>'.  When `false`, these resources are named by the original format: <vm\_hostname>-<resource\_type>-<instance count>.  Default is `false`.                                                                                                                           | `bool`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      | `false`                                      |    no    |
