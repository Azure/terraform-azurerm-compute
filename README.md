...
| <a name="input_extra_disks_by_data_disk_attachment"></a> [extra\_disks\_by\_data\_disk\_attachment](#input\_extra\_disks\_by\_data\_disk\_attachment)      | (Optional) List of extra data disks attached to each virtual machine using a azurerm\_virtual\_machine\_data\_disk\_attachment resource.  Data Disks can be attached either directly by `nb_data_disk` and `extra_disks`, or using the azurerm\_virtual\_machine\_data\_disk\_attachment resource by `nb_data_disk_by_data_disk_attachment` and `extra_disks_by_data_disk_attachment` - but the two cannot be used together.                           | <pre>list(object({<br>    name = string<br>    size = number<br>  }))</pre>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | `[]`                                         |    no    |
...
| <a name="input_nb_data_disk_by_data_disk_attachment"></a> [nb\_data\_disk\_by\_data\_disk\_attachment](#input\_nb\_data\_disk\_by\_data\_disk\_attachment) | (Optional) Number of the data disks attached to each virtual machine using a azurerm\_virtual\_machine\_data\_disk\_attachment resource.  Data Disks can be attached either directly by `nb_data_disk` and `extra_disks`, or using the azurerm\_virtual\_machine\_data\_disk\_attachment resource by `nb_data_disk_by_data_disk_attachment` and `extra_disks_by_data_disk_attachment` - but the two cannot be used together.                           | `number`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `0`                                          |    no    |
