...
```shell
$ docker run --rm -v $(pwd):/src -w /src -e CHECKOV_CONFIG=.checkov_config.yaml mcr.microsoft.com/azterraform:latest make pr-check
```
...
| <a name="input_license_type"></a> [license\_type](#input\_license\_type)                                                                   | Specifies the BYOL Type for this Virtual Machine. This is only applicable to Windows Virtual Machines. Possible values are `Windows_Client` and `Windows_Server`                                                                                                                                                                                                                                                                                       | `string`                                                                    | `null`                                       |    no    |
...
| <a name="input_os_profile_secrets"></a> [os\_profile\_secrets](#input\_os\_profile\_secrets)                                               | Specifies a list of certificates to be installed on the VM, each list item is a map with the keys `source_vault_id`, `certificate_url` and `certificate_store`.                                                                                                                                                                                                                                                                                        | `list(map(string))`                                                         | `[]`                                         |    no    |
