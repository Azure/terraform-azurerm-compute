...
| <a name="input_storage_account_name"></a> [storage\_account\_name](#input\_storage\_account\_name)                                          | (Optional) The name of a Storage Account to create.  Leave empty to skip creating the storage account.  IMPORTANT: Must be lower case letters and numbers ONLY!                                                                                                                                                                                                                                                                                        | `string`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | `null`                                       |    no    |
