...
resource "azurerm_storage_account" "vm_sa" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "eb40196d-4cc5-4327-bfc5-0d2a9553409e"
...
resource "azurerm_virtual_machine" "vm_linux" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "00c11a6f-acd3-4d77-aea6-ae7967cb9a44"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
...
resource "azurerm_virtual_machine" "vm_windows" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "211c1de2-7956-4345-887b-ac95deb2eed2"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
...
resource "azurerm_managed_disk" "vm_data_disk" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "609a0a9f-4ff4-457c-ab2e-9ea0552f2ff4"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
...
resource "azurerm_managed_disk" "vm_extra_disk" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "7a6e53a3-7a4e-4d01-ac41-8d5d5f8308c6"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
...
resource "azurerm_availability_set" "vm" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "b84dc3fc-c52e-47b7-8fd1-86d3c998c7a1"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    avm_yor_name = "vm"
  } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/))
}
...
resource "azurerm_public_ip" "vm" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "bb37a135-a321-4fec-86d5-7415f4e65182"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    avm_yor_name = "vm"
  } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/))
  zones = var.zone == null ? null : [var.zone]
...
resource "azurerm_network_security_group" "vm" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "13f5a8bc-df19-4ddb-bd27-503908926470"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    avm_yor_name = "vm"
  } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/))
}
...
resource "azurerm_network_interface" "vm" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "557f0d77-81f5-4d15-a3a1-be02b0d6263e"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    avm_yor_name = "vm"
  } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/))
...
resource "azurerm_virtual_machine_extension" "extension" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "d6e3cae6-a65c-437b-85e2-16b5a46b69d2"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
...
resource "azurerm_virtual_machine_extension" "extensions" {
  ...
  tags = merge(var.tags, (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
    ...
    avm_git_org              = "syahputra16"
    avm_git_repo             = "terraform-azurerm-compute"
    avm_yor_trace            = "d3abb186-2771-476c-a7b0-921a53b4b20c"
    } /*<box>*/ : replace(k, "avm_", var.tracing_tags_prefix) => v } : {}) /*</box>*/), (/*<box>*/ (var.tracing_tags_enabled ? { for k, v in /*</box>*/ {
